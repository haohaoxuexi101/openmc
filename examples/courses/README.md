...
| Lesson | 主题 | 亮点 |
| --- | --- | --- |
| lesson01_geometry_state.cpp | 几何状态建模 | Surface/Cell 继承 + LessonGeometryState 组合，避免与正式 GeometryState 冲突 |
...
| lesson06_particle_data_bridge.cpp | ParticleData 接口桥接 | 解释 GeometryStateBridge 继承 + 状态字段布局 |
