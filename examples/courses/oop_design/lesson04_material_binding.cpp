...
// 所有教学类均位于 lesson::oop::material_binding 命名空间内，
// 其中 LessonGeometryStateBinding 表示教学版的几何状态容器，
// 以避免与 OpenMC 正式版 GeometryState 产生混淆或命名冲突。
...
int main() {
  using namespace lesson::oop::material_binding;
