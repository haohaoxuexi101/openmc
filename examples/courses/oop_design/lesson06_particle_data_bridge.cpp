...
// 教学代码放入 lesson::oop::particle_bridge 命名空间中，并使用 GeometryStateBridge
// 作为基类名称，以明确它是对 OpenMC GeometryState 的“桥接/教学版”。
...
// ------------------ 示例流程 ------------------
int main() {
  using lesson::oop::particle_bridge::ParticleDataLite;
  // 创建粒子并设置初始几何状态
